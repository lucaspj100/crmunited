...
BEGIN
  ...
  -- Entrevistas MARCADAS: conta cada lead único pela data atual da entrevista (interview_date),
  -- para bater exatamente com o que aparece na Agenda/Dashboard do dia.
  -- Cada lead conta uma única vez por data; não há agrupamento por horário.
  entrev AS (
...
REVOKE EXECUTE ON FUNCTION public.debug_entrevistas_marcadas(date, date, uuid) FROM PUBLIC, anon;
