...
export const LOST_REASONS = [
  ...
  { value: "sem_interesse", label: "Sem interesse", suggestRescueDays: null },
  { value: "sem_dinheiro", label: "Sem dinheiro", suggestRescueDays: 90 },
  { value: "achou_caro", label: "Achou caro", suggestRescueDays: 120 },
  { value: "sem_tempo", label: "Sem tempo", suggestRescueDays: 90 },
  { value: "vai_deixar_depois", label: "Vai deixar para depois", suggestRescueDays: 90 },
  { value: "nao_compareceu", label: "Não compareceu à entrevista", suggestRescueDays: 30 },
